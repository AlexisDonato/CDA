 ...
 */
final class Version20221028064527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, supplier_id INT DEFAULT NULL, name VARCHAR(150) NOT NULL, price INT NOT NULL, description VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(200) DEFAULT NULL, discount TINYINT(1) NOT NULL, quantity INT DEFAULT NULL, image1 VARCHAR(200) DEFAULT NULL, image2 VARCHAR(200) DEFAULT NULL, discount_rate NUMERIC(3, 2) NOT NULL, INDEX IDX_D34A04AD2ADD6D8C (supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
