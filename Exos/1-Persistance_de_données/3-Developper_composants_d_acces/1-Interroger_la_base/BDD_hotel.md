...
## Exercice 1 : Afficher la liste des hôtels.
```sql
...
GROUP BY hot_nom;
```
## Exercice 2 : Afficher la ville de résidence de Mr White
```sql
...
```
## Exercice 4 : Afficher la liste des chambres ayant une capacité > 1
```sql
...
```
## Exercice 5 : Afficher les clients n’habitant pas à Londres
```sql
...
```
## Exercice 6 : Afficher la liste des hôtels située sur la ville de Bretou et possédant une catégorie > 3
```sql
...
```
## Exercice 7 : Afficher la liste des hôtels avec leur station
```sql
...
JOIN hotel;
```
## Exercice 8 : Afficher la liste des chambres et leur hôtel
```sql
...
JOIN chambre;
```
## Exercice 9 : Afficher la liste des chambres de plus d'une place dans des hôtels situés sur la ville de Bretou
```sql
...
```
## Exercice 10 : Afficher la liste des réservations avec le nom des clients
```sql
...
JOIN hotel ON hot_id = cha_hot_id;
```
## Exercice 11 : Afficher la liste des chambres avec le nom de l’hôtel et le nom de la station
```sql
